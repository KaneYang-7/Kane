 ...
 */
function clearAll() {
    const removeMemeImage = document.querySelector('img');
    removeMemeImage.remove();
}
...
function showMeme() {
  ...
  if(document.querySelector('img')===null){
    const firstMemeImage = showMeme.appendChild(memeImage)
    memeImage.setAttribute('src',randomMemeUrl)
  }else{
    document.querySelector('img').setAttribute('src',randomMemeUrl)
  }
}
/**
 * TODO:
...
function showJoke() {
  ...
  if(document.querySelector('.joke')===null){
    const firstJoke = showJoke.appendChild(joke)
    joke.textcontent = randomJokeText
  }else{
    document.querySelector('.joke').textContent = randomJokeText
  }
...
function showQuote() {
  ...
  if (document.querySelector('.quote') === null){
    showQuote.appendChild(quote)
    showQuote.appendChild(author)
...
function showRiddle() {
  ...
  riddleQuestion.setAttribute('class','riddle')
  riddleAnswer.setAttribute('class','answer')
  if (document.querySelector('.riddle') === null){
    showRiddle.appendChild(riddleQuestion)
    showRiddle.appendChild(riddleAnswer)
    riddleQuestion.textContent = randomRiddle.question
    riddleAnswer.textContent = randomRiddle.answer
    document.querySelector('.answer').style.display='none'
  }else{
    document.querySelector('.riddle').textContent = randomRiddle.question
    document.querySelector('.answer').textContent = randomRiddle.answer
    document.querySelector('.answer').style.display='none'
  }
}
...
function revealAnswers() {
    ...
    }else if( document.querySelector('.riddle') !== null &&  document.querySelector('.answer').style.display ==='none' ){
        document.querySelector('.answer').style.display='initial'
    }else
    {
        alert('The anwser is already revealed')
